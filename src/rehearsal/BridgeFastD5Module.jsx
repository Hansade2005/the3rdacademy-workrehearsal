...
import { C, SERIF, SANS } from "./theme-d5.js";
...
const SC3_CONTENT = SC3_CONTENT_D5;
const SC4_CONTENT = SC4_CONTENT_D5;
  ...
  return (
    <Stage bg={C.navyDeep} narrow>
      <div style={{ textAlign: "center", paddingTop: 30 }}>
        ...
        <div style={{ fontFamily: SANS, fontSize: 11, letterSpacing: 2, color: "rgba(255,255,255,0.45)", marginTop: 6 }}>FOUNDATIONAL TIER · BEHAVIOURAL DIMENSION No. 5</div>
        ...
        <p style={{ fontFamily: SERIF, fontStyle: "italic", fontSize: 17, color: "rgba(255,255,255,0.7)", lineHeight: 1.5, maxWidth: 440, margin: "0 auto" }}>
          Behavioural Dimension No. 5 — Collaboration &amp; Conflict Resolution
        </p>
  ...
  return (
    <Stage bg={C.navyDeep} narrow>
      <div style={{ textAlign: "center" }}>
        ...
        <h1 style={{ fontFamily: SERIF, fontWeight: 400, fontSize: 26, color: C.white, lineHeight: 1.4, marginBottom: 10 }}>Behavioural Dimension No. 5 — Collaboration &amp; Conflict Resolution</h1>
...
export default function BridgeFastD5ModuleRoot() {
  return (
    <ModuleErrorBoundary>
      <PiperProvider>
        <BridgeFastD5Module />
  ...
  /* ============== SEGMENT E — SCENARIO LAB ============== */
    ...
    body = (
      <Stage>
        ...
        <DPause2Form persistKey={st.screen} prompt="Write two sentences in Avery’s voice." submit={rr.submitLabel || "Save and continue"} min={rr.minChars || 100}
          onDone={(t) => {
    ...
    body = (
      <Stage bg={C.paper} narrow>
        <div style={{ textAlign: "center", marginBottom: 18 }}>
          ...
          <div style={{ fontFamily: SERIF, fontSize: 20, color: C.navy }}>Behavioural Dimension No. 5 — Collaboration &amp; Conflict Resolution</div>
