...
import { C, SERIF, SANS } from "./theme-d4.js";
...
const SC3_CONTENT = SC3_CONTENT_D4;
const SC4_CONTENT = SC4_CONTENT_D4;
...
export default function BridgeFastD4ModuleRoot() {
  return (
    <ModuleErrorBoundary>
      <PiperProvider>
        <BridgeFastD4Module />
