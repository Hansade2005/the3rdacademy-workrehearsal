...
import { D9_CONTENT, SC1_CONTENT_D9, SC2_CONTENT_D9, SC3_CONTENT_D9, SC4_CONTENT_D9 } from "./d9Content.js";
import { C, SERIF, SANS } from "./theme-d9.js";
...
const D1_CONTENT = D9_CONTENT;
const SC1_CONTENT = SC1_CONTENT_D9;
const SC2_CONTENT = SC2_CONTENT_D9;
const SC3_CONTENT = SC3_CONTENT_D9;
const SC4_CONTENT = SC4_CONTENT_D9;
  ...
  return (
    <Stage bg={C.navyDeep} narrow>
      <div style={{ textAlign: "center" }}>
        ...
        <h1 style={{ fontFamily: SERIF, fontWeight: 400, fontSize: 26, color: C.white, lineHeight: 1.4, marginBottom: 10 }}>Behavioural Dimension No. 9 — Learning Agility</h1>
...
export default function BridgeFastD9ModuleRoot() {
  return (
    <ModuleErrorBoundary>
      <PiperProvider>
        <BridgeFastD9Module />
    ...
    body = (
      <Stage bg={C.paper} narrow>
        <div style={{ textAlign: "center", marginBottom: 18 }}>
          ...
          <div style={{ fontFamily: SERIF, fontSize: 20, color: C.navy }}>Behavioural Dimension No. 9 — Learning Agility</div>
