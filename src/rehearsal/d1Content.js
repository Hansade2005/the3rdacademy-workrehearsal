...
export const SC4_CONTENT = {
  ...
  artifacts: [
    {
      caption: "Slack thread about the shortcut",
      title: "Claims Team Slack Channel — 9:14 AM today",
      mono: true,
      lines: [
        "Jordan M. — 9:14 AM",
        "Anyone else drowning in Q4 claims? I've got 38 open. There is no way I'm doing full docs on all of these.",
        "",
        "Priya S. — 9:16 AM",
        "Same. I'm doing the basics and backfilling later. Nobody checks during crunch week anyway.",
        "",
        "Alex T. — 9:18 AM",
        "Just make sure you get at least one photo and the basic data in. That's enough to hold the file if anyone pulls it.",
        "",
        "Jordan M. — 9:19 AM 👍",
        "",
        "[Your cursor is blinking in the reply field]",
      ],
    },
    {
      caption: "QA report excerpt (ambiguous cue)",
      title: "Internal QA Report — Q3 Review, Claims Division",
      mono: true,
      lines: [
        "\"Claims Dispute Rate by Documentation Level:",
        "    Full documentation:        2.1% dispute rate",
        "    Abbreviated documentation: 2.3% dispute rate",
        "    Difference: not statistically significant (p=0.41)",
        "",
        "Note: Sample period covers a low-dispute quarter. The QA team recommends maintaining full documentation standards regardless of dispute rate trends, as seasonal variation and regulatory audit cycles may produce different results.\"",
        "",
        "[Note: The numbers suggest the shortcut makes almost no difference to outcomes. The QA team still recommends full documentation. The data and the recommendation point in different directions.]",
      ],
    },
  ],
  ...
  consequences: {
    a: {
      sameDay: ["You stay late. By eight PM, you have processed nineteen of forty-two claims — about half what your colleagues processed using the shortcut. You are exhausted and frustrated. You wonder if this was worth it."],
      nextWeek: ["A policyholder disputes a claim decision. The compliance team pulls the file. Your documentation is complete. The dispute is resolved in one review session.", "The same week, a different policyholder disputes one of Jordan’s claims. Jordan’s file has basic data and one photograph. The note says “supporting documentation to follow.” It was not followed. The compliance team escalates the file. Jordan spends two days reconstructing the documentation from memory."],
      monthEnd: ["The quarter-end audit reviews a random sample. Three of yours are in the sample. All three are clean. Your supervisor notices the pattern.", "In your quarterly review, she notes: “Consistently complete documentation even during peak workload.” It is a single line in a review document. But that single line is the difference between being assigned to the standard rotation and being assigned to the high-value commercial claims team — where documentation standards are non-negotiable and the work is more interesting."],
      outcome: "Full documentation maintained through quarter-end. Clean audit sample.",
      others: "The supervisor noted the pattern in your quarterly review.",
      interp: "She held the standard under pressure, while everyone around her bent it.",
      manager: "Supervisor’s perspective. “Everyone takes the shortcut during quarter-end. She did not. The audit only sees the files. The files told me which adjuster is ready for the harder rotation.”",
      traj: "rise",
    },
    b: {
      sameDay: ["You sort your claims by complexity. The twelve high-value claims get full documentation. The remaining thirty get the shortcut. This takes until six thirty — later than the shortcutters, earlier than the full-process approach. It feels like a reasonable professional judgment."],
      nextWeek: ["One of the “straightforward” claims you shortcutted turns complicated. The policyholder adds new information about pre-existing damage. The claim is no longer straightforward — but your documentation treated it as if it were.", "You scramble to upgrade the file. Most of the detail is recoverable, but it takes time you had already moved past."],
      monthEnd: ["Your audit sample includes two fully documented claims and one shortcutted claim. The shortcutted file is flagged.", "Your supervisor notes the inconsistency: “Some of your files are excellent. Others are below standard. The variability is the problem — I need to know that every file meets the standard, not just the ones you decided were important.”", "The compromise felt professional. The audit revealed it as selective compliance."],
      outcome: "Selective compliance based on claim complexity. One shortcutted file flagged.",
      others: "The supervisor flagged the variability — not the average quality.",
      interp: "She decided which files mattered. The audit decided which files mattered.",
      manager: "Supervisor’s perspective. “Risk-based judgment is a professional skill. But the audit does not credit judgment. It credits files. Variability inside one adjuster reads as unreliability, even when the average is fine.”",
      traj: "dip-flat",
    },
    c: {
      sameDay: ["You process at shortcut pace. By five thirty, you have cleared twenty-eight claims. You reply to Jordan’s Slack message: thumbs up. You go home. You plan to backfill the documentation on Monday. You do not write yourself a reminder. You will remember."],
      nextWeek: ["Monday arrives with twelve new claims. You do not backfill last week’s documentation. Tuesday, the same. By Wednesday, the “to follow” notes are a week old and the details are fading from memory.", "You reconstruct one file from memory. The contact log is approximate. The damage narrative is thin. The photographs were taken, but you only uploaded one of three. The verification form is unsigned because the policyholder was not available and you were going to call back. This is what “to follow” really means. It means “to forget.”"],
      monthEnd: ["A policyholder disputes their claim. Your file is incomplete. You spend three days reconstructing the file. Two of the photographs are lost. The signed verification is done after the fact, which the dispute arbitrator notes as irregular.", "The shortcut saved forty-five minutes per claim. The dispute cost three full days and a compliance notation. The mathematics of shortcuts: the savings are immediate; the cost is deferred, compounded, and unpredictable."],
      outcome: "Took the shortcut intending to backfill. The backfill did not happen.",
      others: "The dispute arbitrator noted the irregular post-hoc verification.",
      interp: "She meant to come back. The next week did not let her come back.",
    ...
    d: {
      sameDay: ["You take the shortcut. You move on. You do not pretend you will come back to it. The note in the file says what it says. You trust the system to hold."],
      nextWeek: ["Two of your shortcutted files are pulled for a regulatory audit. The auditor flags both.", "The supervisor’s first question is not about the missing documentation — it is about the disposition. “Are you intending to complete these files, or is this the standard you are submitting?” The answer matters more than the missing documents."],
      monthEnd: ["Your supervisor calls a quiet meeting. She does not raise her voice. She says: “I sent the email last quarter about maintaining standards. You acknowledged it implicitly by being on the team. The shortcut without intent to complete is not a process problem. It is a standards declaration. You told me what your standard is. I have to decide whether it matches the team’s.”", "The shortcut was not the cost. The standards declaration was."],
      outcome: "Took the shortcut with no backfill intent. Two files flagged in audit.",
      others: "The supervisor reframed it as a standards declaration, not a documentation lapse.",
      interp: "She did not pretend she would come back. The supervisor heard exactly that.",
      manager: "Supervisor’s perspective. “The shortcut I can manage. The intent behind the shortcut tells me what standard she is willing to declare. That is what I now have to decide about.”",
      traj: "drop",
    },
  },
  signalPanel: [
