...
import { C, SERIF, SANS } from "./theme-d8.js";
  ...
  return (
    <Stage bg={C.navyDeep} narrow>
      <div style={{ textAlign: "center", paddingTop: 30 }}>
        ...
        <div style={{ fontFamily: SANS, fontSize: 11, letterSpacing: 2, color: "rgba(255,255,255,0.45)", marginTop: 6 }}>FOUNDATIONAL TIER · BEHAVIOURAL DIMENSION No. 8</div>
  ...
  return (
    <Stage bg={C.navyDeep} narrow>
      <div style={{ textAlign: "center" }}>
        ...
        <h1 style={{ fontFamily: SERIF, fontWeight: 400, fontSize: 26, color: C.white, lineHeight: 1.4, marginBottom: 10 }}>Behavioural Dimension No. 8 — Resilience &amp; Recovery</h1>
    ...
    body = (
      <Stage bg={C.paper} narrow>
        <div style={{ textAlign: "center", marginBottom: 18 }}>
          ...
          <div style={{ fontFamily: SERIF, fontSize: 20, color: C.navy }}>Behavioural Dimension No. 8 — Resilience &amp; Recovery</div>
